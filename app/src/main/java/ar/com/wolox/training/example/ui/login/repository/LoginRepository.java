...
import static ar.com.wolox.training.example.utils.Extras.UserLogin.USER_EMAIL;
import static ar.com.wolox.training.example.utils.Extras.UserLogin.USER_SESSION;
...
public class LoginRepository implements LoginRepositoryApi {
    ...
    public void deleteUserSession() {
        mSharedPreferencesManager.store(USER_SESSION, "");
    }
}