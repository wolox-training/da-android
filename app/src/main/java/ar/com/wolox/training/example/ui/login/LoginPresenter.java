...
import static ar.com.wolox.training.example.utils.Constants.EMAIL_PATTERN;
...
public class LoginPresenter extends BasePresenter<ILoginView> {
    ...
    void handleGoogleSignInResult(GoogleSignInResult result) {
        if (result.isSuccess()) {
            getView().onUserLoginSucceeded(createUser(result));
        }
    }

    private User createUser(GoogleSignInResult result) {
        User user = new User();
